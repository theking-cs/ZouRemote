...
```bash
wget -qO- [https://raw.githubusercontent.com/theking-cs/ZouRemote/main/instalar.sh](https://raw.githubusercontent.com/theking-cs/ZouRemote/main/instalar.sh) | bash
